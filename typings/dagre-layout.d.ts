// Adapted version of @types/dagre
// https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/dagre/index.d.ts
...
declare module "dagre" {
  ...
  function layout(graph: graphlib.Graph, layout?: GraphLabel & NodeConfig & EdgeConfig): void;
